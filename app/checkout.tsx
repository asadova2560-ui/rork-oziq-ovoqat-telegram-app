        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.summaryCard}>
            ...
            {items.map((item) => {
              ...
              return (
                <View key={`${item.product.id}_${item.weightGrams ?? "std"}`} style={styles.summaryRow}>
                  <Text style={styles.summaryItemName} numberOfLines={1}>{displayName} x{item.quantity}</Text>
                  <Text style={styles.summaryItemPrice}>{formatPrice(itemTotal)}</Text>
                </View>
              );
            })}
            ...
            <View style={styles.summaryRow}>
              ...
              <Text style={styles.summaryTotalPrice}>{formatPrice(totalPrice)}</Text>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: Colors.surfaceSecondary, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, fontSize: 16, color: Colors.text, borderWidth: 1, borderColor: Colors.borderLight },
  addressInput: { minHeight: 60, textAlignVertical: "top" },
  noteInput: { minHeight: 80, textAlignVertical: "top" },
  savedAddressBtn: { flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 10, paddingVertical: 10, paddingHorizontal: 14, backgroundColor: Colors.primaryLight, borderRadius: 12 },
  savedAddressBtnText: { fontSize: 14, fontWeight: "600", color: Colors.primary },
  locationBtn: { flexDirection: "row", alignItems: "center", gap: 8, marginTop: 10, paddingVertical: 10, paddingHorizontal: 14, backgroundColor: Colors.primaryLight, borderRadius: 12 },
  locationBtnText: { fontSize: 14, fontWeight: "600", color: Colors.primary },
  coordsText: { fontSize: 12, color: Colors.textSecondary, marginTop: 6, marginLeft: 4 },
  paymentOption: { flexDirection: "row", alignItems: "center", padding: 14, borderRadius: 14, borderWidth: 1.5, borderColor: Colors.borderLight, marginBottom: 8, gap: 12 },
  paymentOptionActive: { borderColor: Colors.primary, backgroundColor: Colors.primaryLight },
  paymentIconBox: { width: 44, height: 44, borderRadius: 14, justifyContent: "center", alignItems: "center" },
  ...
  cardProvidersSection: { backgroundColor: Colors.surfaceSecondary, borderRadius: 14, padding: 14, marginBottom: 8 },
  cardProviderHint: { fontSize: 13, fontWeight: "600", color: Colors.textSecondary, marginBottom: 10 },
  cardProvidersRow: { flexDirection: "row", gap: 8 },
  cardProviderBtn: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 5, paddingVertical: 12, paddingHorizontal: 8, backgroundColor: Colors.white, borderRadius: 12, borderWidth: 1.5 },
  cardProviderDot: { width: 8, height: 8, borderRadius: 4 },
  cardProviderName: { fontSize: 13, fontWeight: "700" },
  cardNumberBox: { marginTop: 12, backgroundColor: Colors.white, borderRadius: 10, padding: 12, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  cardNumberLabel: { fontSize: 13, color: Colors.textSecondary, fontWeight: "500" },
  cardNumberValue: { fontSize: 15, fontWeight: "700", color: Colors.text, letterSpacing: 1 },
  summaryCard: { backgroundColor: Colors.white, borderRadius: 16, padding: 16, marginBottom: 12 },
  summaryTitle: { fontSize: 16, fontWeight: "700", color: Colors.text, marginBottom: 12 },
  summaryRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingVertical: 6 },
  summaryItemName: { fontSize: 14, color: Colors.textSecondary, flex: 1, marginRight: 12 },
  ...
  summaryDelivery: { fontSize: 14, fontWeight: "600", color: Colors.accent },
  summaryTotal: { fontSize: 17, fontWeight: "700", color: Colors.text },
  summaryTotalPrice: { fontSize: 20, fontWeight: "800", color: Colors.primary },
  footer: { position: "absolute", bottom: 0, left: 0, right: 0, backgroundColor: Colors.white, padding: 16, borderTopLeftRadius: 24, borderTopRightRadius: 24, shadowColor: "#000", shadowOffset: { width: 0, height: -4 }, shadowOpacity: 0.08, shadowRadius: 12, elevation: 8 },
  submitBtn: { backgroundColor: Colors.primary, borderRadius: 16, height: 56, justifyContent: "center", alignItems: "center" },
  ...
  successSubtext: { fontSize: 15, color: Colors.textSecondary, textAlign: "center", marginTop: 10, lineHeight: 22 },
  successBtn: { backgroundColor: Colors.primary, borderRadius: 16, paddingHorizontal: 32, paddingVertical: 16, marginTop: 30 },
  successBtnText: { fontSize: 16, fontWeight: "700", color: Colors.white },
  modalContainer: { flex: 1, backgroundColor: Colors.background },
  modalHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 16, paddingVertical: 14, backgroundColor: Colors.white, borderBottomWidth: 1, borderBottomColor: Colors.borderLight },
  modalTitle: { fontSize: 17, fontWeight: "700", color: Colors.text },
  modalContent: { padding: 16 },
  addressPickerItem: { flexDirection: "row", alignItems: "center", backgroundColor: Colors.white, borderRadius: 14, padding: 14, gap: 12, marginBottom: 8 },
  addressPickerIcon: { width: 40, height: 40, borderRadius: 12, backgroundColor: Colors.surfaceSecondary, justifyContent: "center", alignItems: "center" },
  addressPickerInfo: { flex: 1 },
  addressPickerTitle: { fontSize: 15, fontWeight: "600", color: Colors.text },
  addressPickerSubtitle: { fontSize: 13, color: Colors.textSecondary },
});
